...
create table orders (id bigserial, user_id bigint not null, price numeric(8, 2) not null, primary key(id), constraint fk_user_id foreign key (user_id) references users (id), isready boolean default false);
